...
EXEC sp_THEMNHANVIEN 'NV01',N'Huỳnh Võ Lan Anh',N'Nữ',N'TPHCM','0388719607','lananhhuynhvo02072002@gmail.com',N'Vật tư',0
--
--Câu 1--
CREATE PROCEDURE sp_THEMNHANVIEN
    @manv VARCHAR,
...
--cau 2
CREATE PROCEDURE ThemMoiSanPham @masp varchar(10), @tenhang varchar(50), @tensp varchar(50), @soluong int, @mausac varchar(20), @giaban float, @donvitinh varchar(20), @mota varchar(100), @Flag int
AS
BEGIN
    SET NOCOUNT ON;
...
EXEC ThemMoiSanPham 'SP10',N'Điện thoại Vivo','Vivo Y31','20','Bạc','1000000',N'Chiếc',N'Hàng cao cấp',0
...
BEGIN
    ...
    END
        ELSE
        BEGIN
            PRINT N'Không được nhập mã lỗi 0'
        END
END
EXEC sp_ThemHangsx1 'Mahangsx','LG',N'China','273702',N'lananh@gmail.com'
...
END
-- cau 7--
CREATE PROCEDURE sanphamNhapDuLieuXuat 
    @sohdx VARCHAR(20),
    @masp VARCHAR(20),
    @manv VARCHAR(20),
    @ngayxuat DATE,
